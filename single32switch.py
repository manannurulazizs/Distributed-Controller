...
def MyNetwork():
    ...
    net.get('switch17').start([c1])
    net.get('switch18').start([c1])
    net.get('switch19').start([c1])
    net.get('switch20').start([c1])
    net.get('switch21').start([c1])
    net.get('switch22').start([c1])
    net.get('switch23').start([c1])
    net.get('switch24').start([c1])
    net.get('switch25').start([c1])
    net.get('switch26').start([c1])
    net.get('switch27').start([c1])
    net.get('switch28').start([c1])
    net.get('switch29').start([c1])
    net.get('switch30').start([c1])
    net.get('switch31').start([c1])
    net.get('switch32').start([c1])
